...
async function shell_ffmpeg_progress(args, {user_friendly_status = s => console.log(s), expected_duration_us, ...options})
{
    ...
    function progress_fn(ffmpeg_progress) {
        ffmpeg_progress.expected_duration_us = expected_duration_us;
